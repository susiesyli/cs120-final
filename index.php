...
function setupEventListeners() {
    ...
    document.getElementById('artworkGrid').addEventListener('click', (e) => {
        ...
        if (card) {
            ...
            // Directly get the artwork details from the current card
    ...
    function updatePreview() {
        ...
        if (selectedArtwork && selectedProduct) {
            ...
            previewContainer.innerHTML = '<p>Select an artwork and product to preview</p>';
    ...
    document.addEventListener('DOMContentLoaded', () => {
        fetchAndDisplayArtworks(6);  // Default to Asian Art
        setupEventListeners();
    });
